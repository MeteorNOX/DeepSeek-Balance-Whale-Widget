...
| `fx-basin.png`（不锈钢盆，彩蛋默认落体素材） | **用户提供**：原图由使用者 2026-09 提供（图内自带「豆包 AI 生成」水印，即 AI 生成图）。已**抠去白底与投影**、边缘羽化，并补成 640×640 正方形（底边对齐，落体框是正方形 + contain）。与其它 `assets/**` 一样不在 MIT 覆盖范围内。 |
